...
/**
 * Stores all information in order to start upload operations.
 * PersistentUploadObject can be stored persistently by {@link
...
public class OCUpload implements Parcelable {
  ...
  /**
   * Absolute path in the remote account to set to the uploaded file (not for
   * its parent folder!)
   */
  ...
  /**
   * Defines the origin of the upload; see constants CREATED_ in {@link
   * UploadFileOperation}
   */
   ...
   * Main constructor
   *
   * @param localPath         Absolute path in the local file system to the file
   *     to be uploaded.
   * @param remotePath        Absolute path in the remote account to set to the
   *     uploaded file.
   * @param accountName       Name of an ownCloud account to update the file to.
   */
  public OCUpload(final String localPath, final String remotePath,
                  final String accountName) {
    if (localPath == null || !localPath.startsWith(File.separator)) {
      throw new IllegalArgumentException(
          "Local path must be an absolute path in the local file system");
    }
    if (remotePath == null || !remotePath.startsWith(OCFile.PATH_SEPARATOR)) {
      throw new IllegalArgumentException(
          "Remote path must be an absolute path in the local file system");
    }
   ...
   *
   * @param  ocFile           {@link OCFile} instance to update in the remote
   *     server.
   * @param  account          ownCloud {@link Account} where ocFile is
   *     contained.
   */
  ...
  // Getters & Setters
  public void setUploadId(final long id) { mId = id; }

  public long getUploadId() { return mId; }

  /**
   * @return the uploadStatus
   */
  public UploadStatus getUploadStatus() { return mUploadStatus; }
   ...
   */
  public UploadResult getLastResult() { return mLastResult; }
  ...
  public void setLastResult(final UploadResult lastResult) {
    this.mLastResult =
        ((lastResult != null) ? lastResult : UploadResult.UNKNOWN);
  }
  ...
  public void setLocalPath(final String localPath) { mLocalPath = localPath; }
  ...
  public void setFileSize(final long fileSize) { mFileSize = fileSize; }
   ...
   */
  public int getLocalAction() { return mLocalAction; }
   ...
   */
  public boolean isForceOverwrite() { return mForceOverwrite; }
   ...
   */
  public boolean createsRemoteFolder() { return mCreatesRemoteFolder; }
  ...
  public void setCreatedBy(final int createdBy) { mCreatedBy = createdBy; }
  ...
  public long getUploadEndTimestamp() { return mUploadEndTimeStamp; }

  public void setTransferId(final String transferId) {
    mTransferId = transferId;
  }

  public String getTransferId() { return mTransferId; }
   ...
   *
   */
  public static final Parcelable.Creator<OCUpload> CREATOR =
      new Parcelable.Creator<OCUpload>() {
        @Override
   ...
   */
  protected OCUpload(final Parcel source) { readFromParcel(source); }
