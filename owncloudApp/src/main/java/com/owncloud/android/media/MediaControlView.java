...
public class MediaControlView
    extends FrameLayout implements OnClickListener, OnSeekBarChangeListener {
  ...
  public void onStartTrackingTouch(final SeekBar seekBar) {
    ...
    mHandler.removeMessages(SHOW_PROGRESS); // grants no more updates with media
                                            // player progress while dragging
  }
  ...
  public void onStopTrackingTouch(final SeekBar seekBar) {
    ...
    mHandler.sendEmptyMessage(
        SHOW_PROGRESS); // grants future updates with media player progress
  }
