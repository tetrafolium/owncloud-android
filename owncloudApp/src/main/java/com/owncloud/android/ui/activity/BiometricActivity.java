...
public class BiometricActivity extends AppCompatActivity {
  ...
  private void showBiometricPrompt() {
    ...
    BiometricPrompt biometricPrompt = new BiometricPrompt(
        BiometricActivity.this, executor,
        new BiometricPrompt.AuthenticationCallback() {
          @Override
          public void onAuthenticationError(final int errorCode, final
          ...
          public void onAuthenticationSucceeded(
              final @NonNull BiometricPrompt.AuthenticationResult result) {
  ...
  /**
   * Generate encryption key involved in biometric authentication process and
   * store it securely on the device using the Android Keystore system
   */
  @RequiresApi(api = Build.VERSION_CODES.M)
  private void generateAndStoreKey() {

    try {
      // Access Android Keystore container, used to safely store cryptographic
    ...
    try {
      // Access Android KeyGenerator to create the encryption key involved in
  ...
  /**
   * Init mCipher that will be used to create the encrypted {@link
   * BiometricPrompt.CryptoObject} instance. This CryptoObject will be used
   * during the biometric authentication process
   *
