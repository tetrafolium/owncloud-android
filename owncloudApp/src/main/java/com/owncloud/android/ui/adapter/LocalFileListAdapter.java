...
public class LocalFileListAdapter extends BaseAdapter implements ListAdapter {
  ...
  public LocalFileListAdapter(final File directory, final boolean justFolders,
  ...
  public View getView(final int position, final View convertView,
    ...
    if (mFiles != null && mFiles.length > position) {
       ...
       * in fileIcon, or
       * {@link ThumbnailsCacheManager#cancelPotentialThumbnailWork} will NEVER
       * cancel any task.
       */
      boolean allowedToCreateNewThumbnail =
          (ThumbnailsCacheManager.cancelPotentialThumbnailWork(file, fileIcon));
      ...
      TextView fileSizeSeparatorTV =
          view.findViewById(R.id.file_list_separator);
      ...
      if (!file.isDirectory()) {
        ...
        fileSizeTV.setText(
            DisplayUtils.bytesToHumanReadable(file.length(), mContext));
        ...
        if (BitmapUtils.isImage(file)) {
          ...
          fileIcon.setImageResource(
              MimetypeIconUtil.getFileTypeIconId(null, file.getName()));
        }
   ...
   *
   * @param directory New file to adapt. Can be NULL, meaning "no content to
   *     adapt".
   */
