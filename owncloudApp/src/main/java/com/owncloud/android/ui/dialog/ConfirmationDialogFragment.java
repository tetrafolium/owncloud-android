...
public class ConfirmationDialogFragment extends DialogFragment {
   ...
   * @param messageArguments  Arguments to complete the message, if it's a
   ...
   * @param posBtn            DataResult id for the text of the positive button.
   *     -1 for no positive button.
   * @param neuBtn            DataResult id for the text of the neutral button.
   *     -1 for no neutral button.
   * @param negBtn            DataResult id for the text of the negative button.
   *     -1 for no negative button.
   * @return Dialog ready to show.
   */
  public static ConfirmationDialogFragment
  newInstance(final int messageResId, final String[] messageArguments,
              final int titleResId, final int posBtn, final int neuBtn,
              final int negBtn) {

    if (messageResId == -1) {
      throw new IllegalStateException(
          "Calling confirmation dialog without message resource");
    }
  ...
  public void
  setOnConfirmationListener(final ConfirmationDialogFragmentListener listener) {
    mListener = listener;
  }
  ...
  public Dialog onCreateDialog(final Bundle savedInstanceState) {
    Object[] messageArguments =
        getArguments().getStringArray(ARG_MESSAGE_ARGUMENTS);
