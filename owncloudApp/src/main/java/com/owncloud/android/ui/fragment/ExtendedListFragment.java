...
public class ExtendedListFragment extends Fragment
  ...
  static final String ARG_JUST_FOLDERS =
      ExtendedListFragment.class.getCanonicalName() + ".JUST_FOLDERS";
  static final String ARG_LIST_FILE_OPTION =
      ExtendedListFragment.class.getCanonicalName() + ".LIST_FILE_OPTION";
  static final String ARG_PICKING_A_FOLDER =
      ExtendedListFragment.class.getCanonicalName() + ".ARG_PICKING_A_FOLDER";
  ...
  protected AbsListView getListView() { return mCurrentListView; }

  FloatingActionButton getFabUpload() { return mFabUpload; }

  FloatingActionButton getFabMkdir() { return mFabMkdir; }

  public FloatingActionsMenu getFabMain() { return mFabMain; }
  ...
  public boolean isGridEnabled() { return (mCurrentListView == mGridView); }
  ...
  public View onCreateView(final LayoutInflater inflater,
    ...
    if (savedInstanceState != null) {
      ...
      if (isGridEnabled()) {
        ...
        Timber.v("Setting and centering around list position %s",
                 referencePosition);
  ...
  public void onActivityCreated(final Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      ...
      mFirstPositions =
          savedInstanceState.getIntegerArrayList(KEY_FIRST_POSITIONS);
      mTops = savedInstanceState.getIntegerArrayList(KEY_TOPS);
      mHeightCell = savedInstanceState.getInt(KEY_HEIGHT_CELL);
      setMessageForEmptyList(
          savedInstanceState.getString(KEY_EMPTY_LIST_MESSAGE));
  ...
  public void onSaveInstanceState(final @NonNull Bundle savedInstanceState) {
    ...
    savedInstanceState.putIntegerArrayList(KEY_FIRST_POSITIONS,
                                           mFirstPositions);
  ...
  protected int getReferencePosition() {
    if (mCurrentListView != null) {
      return (mCurrentListView.getFirstVisiblePosition() +
              mCurrentListView.getLastVisiblePosition()) /
          2;
    } else {
      return 0;
    }
  ...
  protected void restoreIndexAndTopPosition() {
    if (mIndexes.size() > 0) {
      ...
      Timber.v("Setting selection to position: " + firstPosition +
               "; top: " + top + "; index: " + index);
  ...
  protected void saveIndexAndTopPosition(final int index) {
    ...
    mHeightCell =
        (view == null || mHeightCell != 0) ? mHeightCell : view.getHeight();
  }
  ...
  public void
  setOnRefreshListener(final OnEnforceableRefreshListener listener) {
   ...
   * <p>
   * When 'false' is set, prevents user gestures but keeps the option to refresh
   * programatically,
   *
  ...
  protected void
  onCreateSwipeToRefresh(final SwipeRefreshLayout refreshLayout) {
  ...
  protected void setMultiChoiceModeListener(
      final AbsListView.MultiChoiceModeListener listener) {
  ...
  /**
   * TODO doc
   * To be called before setAdapter, or GridViewWithHeaderAndFooter will throw
   * an exception
   *
   * @param enabled
   */
