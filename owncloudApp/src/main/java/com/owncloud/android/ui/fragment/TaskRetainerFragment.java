...
public static final String FTAG_TASK_RETAINER_FRAGMENT =
	"TASK_RETAINER_FRAGMENT";
...
public void onAttach(final Context context) {
	...
	if (mTask != null) {
		if (context instanceof ReceiveExternalFilesActivity) {
			mTask.setListener(
				(CopyAndUploadContentUrisTask.OnCopyTmpFilesTaskListener)context);
		} else {
...
/**
 * Only called once, since the instance is retained across configuration
 * changes
 */
@Override
