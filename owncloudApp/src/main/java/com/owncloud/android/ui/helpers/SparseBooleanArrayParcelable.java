...
/**
 * Wraps a SparseBooleanArrayParcelable to allow its serialization and
 * desearialization through {@link Parcelable} interface.
 */
  ...
  public SparseBooleanArrayParcelable(final SparseBooleanArray sba) {
    if (sba == null) {
      throw new IllegalArgumentException(
          "Cannot wrap a null SparseBooleanArray");
    }
    mSba = sba;
  }

  public SparseBooleanArray getSparseBooleanArray() { return mSba; }
