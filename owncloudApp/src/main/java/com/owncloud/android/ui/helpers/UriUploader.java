...
/**
 * This class examines URIs pointing to files to upload and then requests {@link
 * FileUploader} to upload them.
 *
 * URIs with scheme file:// do not require any previous processing, their path
 * is sent to {@link FileUploader} to find the source file.
 *
 * URIs with scheme content:// are handling assuming that file is in private
 * storage owned by a different app, and that persistency permission is not
 * granted. Due to this, contents of the file are temporary copied by the OC
 * app, and then passed {@link FileUploader}.
 */
