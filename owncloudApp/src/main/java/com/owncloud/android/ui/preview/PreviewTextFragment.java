 ...
 */
public static PreviewTextFragment newInstance(final OCFile file,
 ...
 * automatically (for instance, when the device is turned a aside). <p/> DO
 * NOT CALL IT: an {@link OCFile} and {@link Account} must be provided for a
...
public View onCreateView(final LayoutInflater inflater,
	...
	View ret =
		inflater.inflate(R.layout.preview_text_fragment, container, false);
	...
	if (savedInstanceState == null) {
		...
		if (mAccount == null) {
			throw new IllegalStateException(
				      "Instanced with a NULL ownCloud Account");
		}
	} else {
...
/**
 * Reads the file to preview and shows its contents. Too critical to be
 * anonymous.
 */
private class TextLoadAsyncTask
	extends AsyncTask<Object, Void, StringWriter> {
...
protected StringWriter doInBackground(final java.lang.Object... params) {
	if (params.length != 1) {
		throw new IllegalArgumentException(
			      "The parameter to " + TextLoadAsyncTask.class.getName() + " must "
...
public void onPrepareOptionsMenu(final Menu menu) {
	...
	// this one doesn't make sense since the file has to be down in order to be
	// previewed
 ...
 * PreviewTextFragment} to be previewed.
 *
