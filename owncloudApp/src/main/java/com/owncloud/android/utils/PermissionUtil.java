...
public class PermissionUtil {
   ...
   * Determine whether <em>the app</em> has been granted a particular
   * permission.
   *
   * @param permission The name of the permission being checked.
   * @return <code>true</code> if app has the permission, or <code>false</code>
   *     if not.
   */
   ...
   * in which the permission is requested does not clearly communicate to the
   * user what would be the benefit from granting this permission.
   *
  ...
  shouldShowRequestPermissionRationale(final Activity activity,
                                       final String permission) {
   ...
   */
  public static void
  requestWriteExternalStoreagePermission(final Activity activity) {
